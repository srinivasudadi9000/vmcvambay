                    ...
                    for (int i = 0; i < jsonObject.length(); i++) {
                      ...
                      /*  Picasso.with(ViewPlot.this)
                        ...
                        ImageLoader.getInstance()
                                .displayImage(value.getString("HouseFile"), house_img_copy, options);
                        ImageLoader.getInstance()
                                .displayImage(value.getString("BankLoan"), bankloan_img_copy, options);
                        ImageLoader.getInstance()
                                .displayImage(value.getString("Patta"), patta_img_copy, options);
                        ImageLoader.getInstance()
                                .displayImage(value.getString("House File"), app_family_img, options);
